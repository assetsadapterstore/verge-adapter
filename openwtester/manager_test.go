...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO XVG", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "mainnetXVG", WalletID: walletID, Required: 1, Symbol: "XVG", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	accountID := "BTnXZEYyMd93M7t44KSNdeirpcihYNgHB7tqhEpLDqcW"
